...
const IndexPage = () => (
  <Layout>
    ...
    <p>
      ...
      learn and teach, and look every challenge in the face and know "Well I've
      always figured it out before, why would this time be any different?"
    </p>
    ...
    <p>
      ...
      immediately pursued a Student Hourly position at my school. I was working
      mostly in the media production space and developing distributed education
      technologies.
    </p>
    ...
    <p>
      ...
      several unique types of challenges in private sector including financial,
    ...
    <p>
      ...
      client's problem space, then having the freedom to recommend solutions can
      be extremely rewarding when you do ship the solution, and see the client's
      delight at the results.
    </p>
  </Layout>
)
